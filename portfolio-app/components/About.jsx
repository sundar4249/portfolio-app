    ...
    <div id='about' className='w-full md:h-screen p-2 flex items-center py-16'>
        <div className='max-w-[1240px] m-auto md:grid grid-cols-3 gap-8'>
            <div className='col-span-2'>
                ...
                <p className='py-2 text-gray-600'>Im a software/Web developer with experience in JavaScript and TypeScript and 
                have a good knowledge of frameworks like Next.Js, Angular and llibraries like React and 
                Node.js. Im a quick and good learner and collaborate closely with clients to create efficient, 
